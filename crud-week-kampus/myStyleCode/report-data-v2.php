        ...
        <form action="find.php">
            ...
            <div class="col-md-offset-4">
                ...
                <select name="category" class="form-control" id="sel1" style="width: 30%">
                    ...
                    <button class="btn btn-default form-control" type="submit" style="width: 20%"> <i class="glyphicon glyphicon-search"></i></button>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        if (empty($reportYogiDua)) {
                            echo "Data Tidak di Temukan";
                        } else {
                            // including an result to user_data where it is array object
                            while ($user_data = mysqli_fetch_array($reportYogiDua)) {
                                echo "<tr>";
