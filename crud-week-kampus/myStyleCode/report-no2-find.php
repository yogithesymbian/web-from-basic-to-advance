...
$Nama_majalah = $_GET['Nama_majalah'];
$alamat = $_GET['alamat'];

# check if find_skill have value and category is all -> load this query
if (isset($Nama_member) && isset($Nama_majalah) && isset($alamat)) {
...
<body style="background: url('../../img/white-tech3.jpg')">
    ...
    <div class="container">
        ...
        <!-- EndOfBreadCumb -->
        <h1 class="text-center">Report Data 2</h1>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        if (empty($reportYogiDuaTiga)) {
                            echo "Data Tidak di Temukan";
                        } else {
                            // including an result to user_data where it is array object
                            while ($user_data = mysqli_fetch_array($reportYogiDuaTiga)) {
                                echo "<tr>";
                                echo "<td>" . $user_data['Id_penjualan'] . "</td>";
                                echo "<td>" . $user_data['Nama_member'] . "</td>";
