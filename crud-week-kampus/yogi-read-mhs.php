...
# query for show the category
$category = mysqli_query($CONN, "SELECT
        jur.nm_jur
    FROM
        jurusan jur ");
#query for show the list data on table relation between { jurusan table and mhs table }
...
<body>
    <div class="container">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="http://localhost/kuliah/crud-week-kampus/yogi-read-mhs.php">Read</a></li>
        </ul>
        <!-- EndOfBreadCumb -->
