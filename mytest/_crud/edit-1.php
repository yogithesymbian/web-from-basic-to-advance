...
<body>
    ...
    <!-- generic -->
    <div class="container">
        <h1 class="text-primary text-center">Edit Pegawai</h1>
        <br>
        <form action="edit-1.php" method="post" class="form-horizontal">
            <div class="form-group">
                <label for="id-pegawai" class="col-sm-2 control-label">ID Pegawai</label>
                <div class="col-sm-10">
                    <input type="text" name="id_pegawai" id="id_id_pegawai" class="form-control" value="<?php echo $id_pegawai ?>" required autofocus>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nm_pegawai" id="id_nm_pegawai" class="form-control" value="<?php echo $nm_pegawai ?>">
                </div>
            </div>
